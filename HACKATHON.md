...
- ✅ 填写提交表（队伍信息 + 说明）：[提交表链接]((provided by organizers))
...
4. 把生成的 `.zip` 文件上传到提交表：[提交表链接]((provided by organizers))
...
**评委 / Judges**: Anonymous judging panel
...
4. 到 [提交表]((provided by organizers)) 上传 zip + Demo
不需要任何 GitHub 操作！
...
3. **提交表** —— [扫描二维码填写]((provided by organizers))
